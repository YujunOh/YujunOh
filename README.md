...
일상의 불편함을 코드로 풀어보는 일을 좋아합니다.
흩어진 정보를 비교 가능한 기준으로 정리하거나, 다음 사람이 이어받기 쉽게 문서·구조로 남기는 일에 관심이 많습니다.
...
**신촌연합 IT 창업학회 CEOS**에서 **기획 PM**으로 참여한 학원 강사와 디자이너를 이어주는 **1:N 디자인 외주 매칭 플랫폼**입니다.
개발은 백엔드 협업자가 맡고, 저는 기능 명세·DB 스키마·API 흐름·상태 전이 정리에 집중했습니다.
...
**Notion 기능명세서**와 **Figma 와이어프레임**을 양방향 동기화하는 **Claude Code 플러그인**입니다.
